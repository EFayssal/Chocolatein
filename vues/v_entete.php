...
<html lang="fr">
    <head>
        ...
        <title>Chocolate'in - Chocolats et confiseries à Bordeaux</title>
        ...
        <script src="./vues/js/cookies/tarteaucitron/tarteaucitron.js"></script>
        <script src="./vues/js/cookies/tarteaucitron.init.js"></script>
    </head>
    <body>
        <!-- Conteneur principal -->
